    ...
    def run(self, file_path, dirty_path, clean_path):
        ...
        if True:
            ...
            if not PERFECTED:
                ...
                repair_res = copy.deepcopy(dirty_df)
...
holistic_res_path = sys.argv[3]
print(f"holistic_res_path : {holistic_res_path}")
...
try:
    ...
    bd = Holistic()
    repair_res = bd.run(rule_path, dirty_path, clean_path)
...
# holistic_res_path = 'Repaired_res/holistic_hos_0319.csv'
# holistic_res_path = config['holistic_res_path']
# holistic_res_path = sys.argv[2]
repair_res.to_csv(holistic_res_path, index=False)
