...
sys.path.append(os.path.abspath("raha-master"))
import raha
import warnings
...
baran_res_path = sys.argv[3]
print(f"baran_res_path : {baran_res_path}")
...
# baran_res_path = sys.argv[2]
repaired_df.to_csv(baran_res_path, index=False)
