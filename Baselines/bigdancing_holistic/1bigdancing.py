...
if __name__ == "__main__":
    ...
    task_name = "hospital1"
    # clean_path = "./data_with_rules/tax/split_data/tax-clean-clean_data_ori-1.csv"
    ...
    # task_name = "tax"
    # dirty_path = "Daisy/dirty_test1-inner_outer_error-02.csv"
    # clean_path = "Daisy/clean_test1.csv"
    # rule_path = "data_with_rules/generate_datav2_1224/dc_rules-validate-fd-horizon.txt"
    # task_name = "test_jira"
    ONLYED = 0
    PERFECTED = 0
    ...
    try:
        ...
        bd = BigDansing()
        repaied_df = bd.run(rule_path, dirty_path, clean_path)
